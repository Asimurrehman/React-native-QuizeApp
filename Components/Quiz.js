    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{flex:0.15,flexDirection:'row',justifyContent:'space-around'}} >
                <Text style={{color:'green',fontSize:17,fontWeight:'bold'}} >{queCount+1} of 10</Text>
            ...
            <Text style={{textAlign:'center',fontSize:20,fontWeight:'bold',borderWidth:5 ,borderRadius:5,padding:10}}>Qno#{queCount +1} : {quizData[queCount].question}</Text>                
...

{
    ...
    <View style={{alignItems:'center'}}>
        ...
        <Text style={{fontSize:28,fontWeight:'bold',color:'green'}}>Congratulations ! Passed</Text>
    </View>
    :
    <View style={{alignItems:'center'}}>
        <Image source={require('../assets/fail.png')} style={{width:100,height:100}} />
        <Text style={{fontSize:28,fontWeight:'bold',color:'red'}} >Failed! Try again</Text>
    </View>
}
<Text>{'\n'}</Text>
...
<Text style={{fontSize:18,fontWeight:'bold',color:'green'}}>{correctAnswerCounts}/10 ({correctAnswerCounts}0%)</Text>
<Text>Marks Of Quiz</Text>
</View>

<View style={{alignItems:'center',margin:10}}>
<Text style={{fontSize:18,fontWeight:'bold',color:'red'}}>{minute}:{second}</Text>
<Text>Quize Complete Time</Text>
</View>
...
<Text>{'\n'}</Text>
           ...
           <Button title='Try Again' onPress={(e)=>NativeModules.DevSettings.reload()} />
